...
\spec{\og voir liste sur le site de votre \'{e}cole doctorale \fg{}}

%Attention : le pr\'{e}nom doit être en minuscules (Jean) et le NOM en majuscules (BRITTEF) 
%Attention : the first name in small letters and the name in Capital letters 
\author{\og Pr\'{e}nom NOM \fg{}}

% Donner le titre complet de la th\`{e}se, \'{e}ventuellement le sous titre, si n\'{e}cessaire sur plusieurs lignes 
%Give the complete title of the thesis, if necessary on several lines
\title{\og Titre de la th\`{e}se \fg{}}
\lesoustitre{\og Sous-titre de la th\`{e}se \fg{}}
...
\uniterecherche{\og voir liste sur le site de votre \'{e}cole doctorale \fg{}}
...
%\numthese{\og si pertinent \fg{}} % \numthese{} - weird character before, instead of the text.
%\numthese{\LaTeX} % \numthese{} % test - produces the content, no text ot weird character before.
